import type { TableAttributes, TableBodyAttributes, TableHeadAttributes } from '../createViewModel.js'
import type { DeriveFn, NewTablePropSet, TablePlugin } from '../types/TablePlugin.js'
import { derived } from 'svelte/store'

export const addGridLayout =
    <Item>(): TablePlugin<Item, Record<string, never>, Record<string, never>, NewTablePropSet<never>> =>
    ({ tableState }) => {
        const pluginState = {}

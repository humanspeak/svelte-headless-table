...
export const getFlattenedRows = <Item, Row extends BodyRow<Item>>(rows: Row[], depth: number): Row[] => {
...
export const addFlatten =
    <Item>({ initialDepth = 0 }: FlattenConfig = {}): TablePlugin<Item, FlattenState, FlattenColumnOptions<Item>, FlattenPropSet> =>
    () => {

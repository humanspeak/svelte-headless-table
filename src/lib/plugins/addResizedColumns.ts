...
export const addResizedColumns =
    <Item>({ onResizeEnd }: AddResizedColumnsConfig = {}): TablePlugin<Item, ResizedColumnsState, ResizedColumnsColumnOptions, ResizedColumnsPropSet, ResizedColumnsAttributeSet> =>
    ({ columnOptions }) => {
